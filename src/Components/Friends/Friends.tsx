...
import {Follow, getFriends, UserType} from "../../State/Users-reducer";
...
const Friends = React.memo(() => {
    ...
    const friends = useSelector<AppRootStateType, UserType[]>(state => state.userPage.friends, _.isEqual)
                ...
                {friends.map((el) => {
                    return <Paper elevation={4} className={s.FriendContainer}>
                        ...
                        <div style={{margin: '0 auto', display: 'flex', justifyContent: 'center'}}>
                            <Button onClick={() => onClickHandler(el.id)}><Avatar
                                sx={{backgroundColor: '#1976d2'}}><PersonOutlineIcon/></Avatar></Button>
